sap.ui.define(["bafar/flujos/flujos/controller/BaseController", "sap/ui/core/mvc/XMLView"], function (BaseController, XMLView) {
  "use strict";
  ...
  return BaseController.extend(
    "bafar.flujos.flujos.controller.Aprobacion.AprobacionFlow", {
      ...
      onInit: function () {
        ...
        oRouter.getRoute("RouteApprovalFlowView").attachPatternMatched((oEvent) => {
          console.log("loaded");
      ...
      onPageLoaded: function (oEvent) {
        ...
        // this.byId("pageId").setTitle(this.oUserCode);
      },
      ...
      addSpecFlow: async function (flowConfig) {
        ...
        this.views.forEach((view) => {
          viewArr.push(this.specificFlow("panelId", view.controllerName, view.viewId, view.viewName));
